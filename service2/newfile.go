...
func (war *Warrior) printInfo() {
	fmt.Printf(" : %s , %s have %.2f health and %d weapon and %d shield \n", war.name, war.unitType, war.Healths, war.Weapon, war.Shield)
}
func (mage *Mage) printInfo() {
	fmt.Printf(" : %s , %s have %.2f health and %d magic and %d age \n", mage.name, mage.unitType, mage.Healths, mage.Magic, mage.Age)
}
func (wi *Witch) printInfo() {
	fmt.Printf(" : %s , %s have %.2f health and %d magic and %d shield \n", wi.name, wi.unitType, wi.Healths, wi.Magic, wi.Shield)
}
func (ar *Archer) printInfo() {
	fmt.Printf(" : %s , %s have %.2f health and %d number of arrows and %d shield \n", ar.name, ar.unitType, ar.Healths, ar.Numberofarrows, ar.Shield)
}
...
func Battle() {
	...
	print("time has passed since launch = ")
	print(timeHasPassed.Seconds())
	print(" seconds")
}
